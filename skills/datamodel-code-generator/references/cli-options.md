...
- `--target-pydantic-version`: Target Pydantic version for generated code. '2': Pydantic 2.7+ compatible (default, uses populate_by_name). '2.11': Pydantic 2.11+ (uses validate_by_name). Choices: `2`, `2.11`.
