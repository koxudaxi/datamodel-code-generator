...
- `--preset`: Apply an immutable built-in option preset. Presets require an explicit --target-python-version so generated syntax is pinned. Choices: `standard-20260619`, `practical-20260619`.
