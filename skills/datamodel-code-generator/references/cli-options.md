...
- `--job`: Run a named job from pyproject.toml [tool.datamodel-codegen.jobs.<name>]. Can be repeated.
- `--all-jobs`: Run every named job from pyproject.toml in declaration order.
