...
base_options.add_argument('--input', help='Input file/directory (default: stdin)')
base_options.add_argument(
    '--input-file-type',
    help='Input file type (default: auto)',
    choices=[i.value for i in InputFileType],
)
base_options.add_argument('--output', help='Output file (default: stdout)')
base_options.add_argument(
    '--output-model-type',
...
base_options.add_argument(
    '--url', help='Input file URL. `--input` is ignored when `--url` is used'
)
...
template_options.add_argument(
    '--aliases', help='Alias mapping file', type=FileType('rt')
)
template_options.add_argument(
