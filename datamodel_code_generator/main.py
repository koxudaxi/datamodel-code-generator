...
from typing import Dict, Type, Optional, List, Tuple, Any, Set

from datamodel_code_generator.model import DataClass, BaseModel, DataModelField, Alias, DataModel
...
class Converter:
    ...
    def convert_object(self, name: str, obj: Dict):
