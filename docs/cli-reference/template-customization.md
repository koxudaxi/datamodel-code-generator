...
The `--class-decorators` flag allows you to specify custom decorators as a
comma-delimited list that will be added to all generated model classes. This
is useful for integrating with serialization libraries like `dataclasses_json`,
or adding custom behavior to your models.
...
**See also:** [Custom Class Decorators Guide](../class-decorators.md)
