...
| [`--builtin-format-line-length`](#builtin-format-line-length) | Set line length for the built-in formatter. |
...
**See also:** [Formatter behavior](../formatter-behavior.md), [Code Formatting](../formatting.md)

!!! tip "Usage"

    ```bash
    datamodel-codegen --input schema.json --formatters builtin --builtin-format-line-length 120 # (1)!
    ```
