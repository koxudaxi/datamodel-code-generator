...
| [`--builtin-format-line-length`](#builtin-format-line-length) | Set line length used by the built-in formatter. |
...
## `--builtin-format-line-length` {#builtin-format-line-length}
...
**Related:** [`--formatters`](template-customization.md#formatters)

!!! tip "Usage"

    ```bash
    datamodel-codegen --input schema.json --formatters builtin --builtin-format-line-length 40 --use-annotated --disable-timestamp # (1)!
    ```

    1. :material-arrow-left: `--builtin-format-line-length` - the option documented here
