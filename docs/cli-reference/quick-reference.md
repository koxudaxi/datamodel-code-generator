...
| [`--no-use-closed-typed-dict`](typing-customization.md#no-use-closed-typed-dict) | Control PEP 728 TypedDict closed/extra_items generation. |
...
| [`--use-closed-typed-dict`](typing-customization.md#use-closed-typed-dict) | Control PEP 728 TypedDict closed/extra_items generation. |
