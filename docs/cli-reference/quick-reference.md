...
| Option | Description |
|--------|-------------|
| [`--all-jobs`](utility-options.md#all-jobs) | Run every named generation job from pyproject.toml |
...
| [`--job`](utility-options.md#job) | Run a named generation job from pyproject.toml |
