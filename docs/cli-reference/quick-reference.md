...
| [`--diff-against`](general-options.md#diff-against) | Compare generated code from two local schema revisions without writing generated... |
...
- [`--diff-against`](general-options.md#diff-against) - Compare generated code from two local schema revisions witho...
- [`--disable-appending-item-suffix`](template-customization.md#disable-appending-item-suffix) - Disable appending 'Item' suffix to array item types.
