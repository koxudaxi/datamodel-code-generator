...
| [`--locked`](general-options.md#locked) | Pin remote schema bytes in a project lock file. |
| [`--lockfile`](general-options.md#lockfile) | Pin remote schema bytes in a project lock file. |
...
| [`--update-lock`](general-options.md#update-lock) | Pin remote schema bytes in a project lock file. |
