...
from datamodel_code_generator.util import BaseModel, model_copy, model_dump, model_validate
...
if TYPE_CHECKING:
    ...
    from datamodel_code_generator.config import ParserConfig, ParserConfigDict
    ...
    def __init__(
        ...
        **options: Unpack[ParserConfigDict],
        ...
        if config.target_datetime_class is None:
            config = model_copy(config, update={"target_datetime_class": DatetimeClassType.Awaredatetime})
