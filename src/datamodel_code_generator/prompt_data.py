...
OPTION_DESCRIPTIONS: dict[str, str] = {
    ...
    "--locked": "Pin remote schema bytes in a project lock file.",
    "--lockfile": "Pin remote schema bytes in a project lock file.",
    ...
    "--update-lock": "Pin remote schema bytes in a project lock file.",
