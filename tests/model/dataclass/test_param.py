...
class TestDataClassFrozen:
    ...
    def test_dataclass_without_frozen(self) -> None:
    ...
    def test_dataclass_with_frozen(self) -> None:
    ...
    def test_dataclass_with_keyword_only_and_frozen(self) -> None:
    ...
    def test_dataclass_with_only_keyword_only(self) -> None:
    ...
    def test_dataclass_frozen_attribute(self) -> None:
    ...
    def test_dataclass_frozen_false_attribute(self) -> None:
    ...
    def test_dataclass_kw_only_true_only(self) -> None:
