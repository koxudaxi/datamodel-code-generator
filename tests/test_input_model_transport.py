...
def test_input_model_transport_property_names_uses_expression() -> None:
    """A transported propertyNames type reaches the generated dict key."""
    collector = PythonTypeExpressionCollector()
    ...
    assert_output(f"{generated}\n", EXPECTED_INPUT_MODEL_PATH / "transport_property_names.py")
