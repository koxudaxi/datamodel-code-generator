...
def test_generate_with_config_parameter() -> None:
    """Test generate() with config parameter extracts all values correctly."""
    from datamodel_code_generator import GenerateConfig

    json_schema = '{"type": "object", "properties": {"user_name": {"type": "string"}}}'
...
def test_generate_config_lazy_import() -> None:
    ...
    assert config_class.__name__ == "GenerateConfig"
