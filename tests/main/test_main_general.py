...
def test_builtin_formatter_uses_line_length_option(output_file: Path) -> None:
    """Test built-in formatter uses CLI line length option."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "simple_string.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--formatters", "builtin", "--builtin-format-line-length", "140", "--disable-timestamp"],
        expected_output="""\
# generated by datamodel-codegen:
#   filename:  simple_string.json
