...
def test_main_root_sequence_final_types(
    ...
    """Resolve helper references after imports and retain native set semantics."""
...
def test_explicit_frozen_set_hashes(
    ...
    with _generated_model(output, "explicit_set_output", "Container") as container:
        ...
        runtime.update(
            ...
            == MODELS[case.get("source", case["name"])]
        ...
        with pytest.raises(ValidationError):
            MODELS[case.get("source", case["name"])].model_validate_json(
