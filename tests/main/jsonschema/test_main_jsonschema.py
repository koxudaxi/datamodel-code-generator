...
def test_main_jsonschema_not_property_names_count_conflict(output_file: Path) -> None:
    """Test not required can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "not_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_not_anyof_property_names_count_conflict(output_file: Path) -> None:
    """Test not anyOf branches can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "not_anyof_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_dependent_schema_not_property_names_count_conflict(output_file: Path) -> None:
    """Test dependent schema not branches can make finite propertyNames impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "dependent_schema_not_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_dependent_schema_max_properties_count_conflict(output_file: Path) -> None:
    ...
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "dependent_schema_max_properties_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_conditional_if_anyof_property_names_count_conflict(output_file: Path) -> None:
    """Test conditional if anyOf branches can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "conditional_if_anyof_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_conditional_then_not_property_names_count_conflict(output_file: Path) -> None:
    """Test conditional then not branches can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "conditional_then_not_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_anyof_not_property_names_count_conflict(output_file: Path) -> None:
    """Test anyOf not branches can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "anyof_not_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_oneof_not_property_names_count_conflict(output_file: Path) -> None:
    """Test oneOf not branches can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "oneof_not_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_nullable_string_enum_excludes_null_intersection(output_file: Path) -> None:
    """Test nullable string enums that exclude null drop nullable fields."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "nullable_string_enum_excludes_null_intersection.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="nullable_string_enum_excludes_null_intersection.py",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        force_exec_validation=True,
    )
    assert_generated_model_json_validation(
        output_file,
        module_name="nullable_string_enum_excludes_null_intersection",
        model_name="NullableStringEnumExcludesNullIntersection",
        valid_json='{"value":"x"}',
        invalid_json='{"value":null}',
        expected_error_type="enum",
        expected_attribute_path=("value", "value"),
        expected_attribute_value="x",
    )


def test_main_jsonschema_nullable_integer_enum_excludes_null_intersection(output_file: Path) -> None:
    """Test nullable integer enums that exclude null drop nullable fields."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "nullable_integer_enum_excludes_null_intersection.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="nullable_integer_enum_excludes_null_intersection.py",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        force_exec_validation=True,
    )
    assert_generated_model_json_validation(
        output_file,
        module_name="nullable_integer_enum_excludes_null_intersection",
        model_name="NullableIntegerEnumExcludesNullIntersection",
        valid_json='{"value":2}',
        invalid_json='{"value":null}',
        expected_error_type="enum",
        expected_attribute_path=("value", "value"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            {
                ...
                "type": "string",
                "minLength": 2,
                "anyOf": [{"enum": ["a"]}, {"const": "b"}],
            },
            id="anyof-enum-common-length-disjoint",
        ),
        ...
        pytest.param(
            ...
            id="allof-property-names-dependent-schema-max-properties",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            {
                ...
                "minProperties": 1,
                "allOf": [
                    {"propertyNames": {"enum": ["blocked"]}},
                    {"not": {"required": ["blocked"]}},
                ],
            },
            id="allof-property-names-not-required-min-properties",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            {
                ...
                "allOf": [
                    {"propertyNames": {"enum": ["allowed"]}},
                    {"oneOf": [{"required": ["allowed"]}, {"minProperties": 1}]},
                ],
            },
            id="allof-property-names-oneof-min-properties",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            ...
            id="object-property-names-oneof-min-properties",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            ...
            id="object-finite-property-names-not-anyof-disjoint",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            {
                ...
                "propertyNames": {"enum": ["a", "b"]},
                "minProperties": 2,
                "anyOf": [{"not": {"required": ["a"]}}, False],
            },
            id="object-finite-property-names-anyof-not-disjoint",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            {
                ...
                "propertyNames": {"enum": ["a", "b"]},
                "minProperties": 2,
                "oneOf": [{"not": {"required": ["missing"]}}, {"minProperties": 2}],
            },
            id="object-finite-property-names-oneof-not-disjoint",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            {
                ...
                "propertyNames": {"enum": ["trigger", "other"]},
                "minProperties": 2,
                "if": {"anyOf": [{"required": ["trigger"]}, {"required": ["missing"]}]},
                "then": {"maxProperties": 1},
            },
            id="object-finite-property-names-conditional-if-anyof-disjoint",
        ),
        pytest.param(
            {
                "title": "Payload",
                ...
                "minProperties": 2,
                "if": {"required": ["trigger"]},
                "then": {"not": {"required": ["other"]}},
            },
            id="object-finite-property-names-conditional-then-not-disjoint",
        ),
        pytest.param(
            {
                "title": "Payload",
        ...
        pytest.param(
            ...
            id="object-finite-property-names-dependent-schema-not-disjoint",
        ),
    ],
)
...
def test_main_jsonschema_anyof_enum_common_constraints(output_file: Path) -> None:
    """Test common constraints filter anyOf enum branches before enum extraction."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "anyof_enum_common_constraints.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="anyof_enum_common_constraints.py",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        force_exec_validation=True,
    )
    assert_generated_model_json_validation(
        output_file,
        module_name="anyof_enum_common_constraints",
        model_name="AnyOfEnumCommonConstraints",
        valid_json='{"code":"bb","count":2}',
        invalid_json='{"code":"a","count":2}',
        expected_error_type="enum",
    )
    assert_generated_model_json_validation(
        ...
        module_name="anyof_enum_common_constraints",
        model_name="AnyOfEnumCommonConstraints",
        valid_json='{"code":"cc","count":3}',
        invalid_json='{"code":"cc","count":1}',
        expected_error_type="enum",
    )


def test_main_jsonschema_anyof_enum_common_constraints_conflict(output_file: Path) -> None:
    """Test anyOf enum branches filtered out by common constraints are rejected."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "anyof_enum_common_constraints_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
...
def test_main_jsonschema_allof_type_intersection(output_file: Path) -> None:
    """Test allOf type branches intersect primitive JSON types."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "allof_type_intersection.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="allof_type_intersection.py",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        force_exec_validation=True,
    )
    assert_generated_model_json_validation(
        output_file,
        module_name="allof_type_intersection",
        model_name="AllOfTypeIntersection",
        valid_json='{"intNumber":1,"nullableString":"x","listValue":1}',
...
def test_main_jsonschema_allof_dependent_schema_max_properties_count_conflict(output_file: Path) -> None:
...
def test_main_jsonschema_allof_not_property_names_count_conflict(output_file: Path) -> None:
...
def test_main_jsonschema_allof_oneof_property_names_count_conflict(output_file: Path) -> None:
    """Test allOf sibling oneOf branches can make finite propertyNames counts impossible."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "allof_oneof_property_names_count_conflict.json",
        output_path=output_file,
        input_file_type="jsonschema",
        extra_args=["--output-model-type", "pydantic_v2.BaseModel"],
        expected_exit=Exit.ERROR,
