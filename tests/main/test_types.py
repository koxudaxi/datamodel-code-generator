...
def test_imports_with_literal_one() -> None:
    ...
    data_type = DataType(literals=[""], python_version=PythonVersion.PY_313)
...
def test_imports_with_literal_one_and_optional() -> None:
    ...
    data_type = DataType(literals=[""], is_optional=True, python_version=PythonVersion.PY_313)
...
def test_imports_with_nested_dict_key() -> None:
    ...
    dict_key_type = DataType(literals=["key"], python_version=PythonVersion.PY_313)

    data_type = DataType(python_version=PythonVersion.PY_313, dict_key=dict_key_type)
...
def test_imports_without_duplicate_literals() -> None:
    ...
    dict_key_type = DataType(literals=["key1"], python_version=PythonVersion.PY_313)
