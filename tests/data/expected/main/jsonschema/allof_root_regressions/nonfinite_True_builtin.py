...
class Root(RootModel[float]):
    model_config = ConfigDict(
        json_schema_extra={'enum': [float('inf'), float('-inf'), float('nan'), 1.5]},
    )
    ...
    def _validate_json_schema_literal(cls, value: Any) -> Any:
        ...
        allowed_values = [float('inf'), float('-inf'), float('nan'), 1.5]
        if not any(
