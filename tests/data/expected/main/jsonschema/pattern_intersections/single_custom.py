...
# Intersection context defined: False
...
class Root(_JsonSchemaRuntimeValidationBase):
    ...
    # Pattern rule fields: declared_properties, pattern_properties, rejected_patterns, additional_property_type, allow_unmatched
