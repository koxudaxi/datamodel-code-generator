...
PYTHON_ROOT_EXPECTED = DATA_PATH / "expected/main/input_model/root_models"
...
def test_python_root_model_inputs(
    tmp_path: Path, entrypoint: str, input_format: str, case: dict, monkeypatch: pytest.MonkeyPatch
) -> None:
