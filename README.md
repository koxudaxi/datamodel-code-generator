...
Model customization:
  ...
  --collapse-root-models
                        Models generated with a root-type field will be merged into the models using that root-type
                        model
  ...
  --use-exact-imports   import exact types instead of modules, for example: "from .foo import Bar" instead of "from .
...
OpenAPI-only options:
  ...
  --validation          Deprecated: Enable validation (Only OpenAPI). this option is deprecated. it will be removed in
                        future releases
